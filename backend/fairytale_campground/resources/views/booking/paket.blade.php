    ...
    <div class="row justify-content-center gy-5">
        ...
        @foreach($paketList as $paket)
            ...
            <div class="col-md-4 d-flex justify-content-center">
                <div class="card shadow-md border-2 rounded-3 w-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title fw-bold mb-2 text-center text-capitalize text-2xl">{{ $paket->nama_paket }}</h5>
                        <p class="card-text text-muted mb-2" style="white-space: pre-line;">{{ $paket->deskripsi }}</p>
                        
                        <button type="button" 
                            class="btn btn-success mt-auto"
                            data-bs-toggle="modal"
                            data-bs-target="#modal{{ $paket->paket_id }}">
                            Lihat Detail
                        </button>
